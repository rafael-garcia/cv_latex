...
\begin{experiences}
  \experience
    ...
    \begin{itemize}
      ...
      \item Maintenance and refactoring of this \textbf{Rails} platform to add support to new types of contents and to decouple its dependencies from other Movile's systems;
      \item All of the PlayKids content relies on the information provided by our platform.\\
    \end{itemize}
  }
  {Ruby, Rails, Kotlin, Vue, ECMAScript 2016+, Babel, Less, Bootstrap, HTML5, npm/yarn, Java 8, Spring Framework, Jetty, PostgresSQL, EC2, S3, Git, IntelliJ, WebStorm, RubyMine}
  \emptySeparator
  \experience
